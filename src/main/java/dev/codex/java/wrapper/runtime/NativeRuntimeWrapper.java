...
public final class NativeRuntimeWrapper {
    ...
    public static FileDescriptor open(String pathname, OptionFlag...flags) throws Error {
        return NativeRuntimeWrapper.open(pathname, AccessFlag.READ_ONLY, flags);
    }
    ...
    public static FileDescriptor creat(String pathname) throws Error {
        return NativeRuntimeWrapper.creat(pathname, AccessFlag.WRITE_ONLY);
    }

    public static FileDescriptor creat(String pathname, AccessFlag mode) throws Error {
        return NativeRuntimeWrapper.open(pathname, mode, OptionFlag.CREAT, OptionFlag.TRUNCATE);
    }

    public static FileDescriptor openat(FileDescriptor dirfd, String pathname, OptionFlag... flags) throws Error {
        return NativeRuntimeWrapper.openat(dirfd, pathname, AccessFlag.READ_ONLY, flags);
    }
