...
rm="rm ./src/main/resources/lib*.so"
echo "$rm"
if ! eval "$rm"; then
  echo "Error removing resources..."
  exit 1
fi
...
cmake_build="cmake --build /home/treyvon/src/glib-wrapper/target/cmake-build-debug --target $1 -j 10"
echo "$cmake_build"
